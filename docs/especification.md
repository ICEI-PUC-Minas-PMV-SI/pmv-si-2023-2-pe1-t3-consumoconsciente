...
|RF-006| O sistema deve permitir que o usuário logado registre uma lista de suas compras e que possa ser classificada como essencial ou não| ALTA | |RF-007| O sistema deve permitir que o usuário logado visualize e edite os itens registrados| ALTA |
