...
Consumismo (1), o ato de adquirir bens ou produtos sem a real necessidade. Se diferencia do consumo onde a aquisição de um bem ou serviço se faz necessário (2).

Uma recente pesquisa feita pelo SERASA (3), foi constatado que de 10 famílias, 8 se encontram endividadas, e a principal causa é o uso do cartão de crédito. O uso do cartão de crédito, se usado de forma consciente, se torna um aliado no orçamento familiar. O problema é o seu uso de forma descontrolada, assim, comprometendo a renda, talvez, por um longo período e aumentando o risco de inadimplência.
